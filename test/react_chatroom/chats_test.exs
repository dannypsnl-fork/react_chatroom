defmodule ReactChatroom.ChatsTest do
  use ReactChatroom.DataCase

  alias ReactChatroom.Chats
  ...
  describe "users" do
    alias ReactChatroom.Chats.User
    ...
    test "update_user/2 with valid data updates the user" do
      user = user_fixture()
      assert {:ok, %User{} = user} = Chats.update_user(user, @update_attrs)
  ...
  describe "messages" do
    alias ReactChatroom.Chats.Message
